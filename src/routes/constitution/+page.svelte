...
<div class="constitution">
    ...
    <p>14 Bench (Expanded by 4 between the league draft and start of 2023-2024 season, no more bench expansion planned.)</p>

    <p>2 IR Spots (Player must be labeled as IR or Covid in the Sleeper App)</p>

    <h3 class="subSectionHeading" bind:this={oneTwo}>1.2 Trading</h3>
    
    <p>Trading of players and draft picks (up to 3 drafts away) are allowed. Trades will process upon commissioner push through after both parties confirm they want it pushed. Tradable assets include players and draft picks.</p>
    ...
    <div class="subBlock">
        <p>Any player traded from a team may not be re-acquired via trade within 1 week of the original trade unless there is a large change in circumstance. Any teams involved in this behavior will be subject to the aforementioned collusion punishments.</p>
    </div>
    
    <h4 bind:this={oneTwoThree}>1.2.3 Trade Deadline</h4>
    <div class="subBlock">
        <p>The trade deadline will be set for the beginning of Week 11.</p>
    </div>
    ...
    <p>FAAB Waiver wire system. Each team will begin the season with priority based on the reversal of last season's standing. Bids will process Wednesday and Saturdays at 3AM EST.</p>
    ...
    <p>The draft order each year will be a linear draft in reverse order of the previous year’s regular season standings (with the exception of a sacko game, if agreed upon.).</p>

    <h3 bind:this={twoTwo}>2.2 Rookie Drafts</h3>
    <p>Rookie drafts will consist of 4 rounds of drafting, with 2 minutes alotted for each pick. To make room for the incoming players, benches will be expanded by 4 spots. These spots will be removed in mid-August, at which point you will need to have cut the necessary players.</p>
    ...
    <p>At the end of the season 6 teams will make the playoffs. The first round of playoffs will commence in week 15 with a game being played every week until the finals in week 17.</p>
